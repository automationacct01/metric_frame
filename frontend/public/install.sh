...
if [ -t 0 ]; then
    ...
    echo "  Adds a self-signed TLS certificate so all traffic is encrypted."
    echo "  You'll access MetricFrame at https://localhost instead of http://localhost:3000"
    echo "  (Your browser will show a one-time certificate warning — this is expected)"
    echo ""
